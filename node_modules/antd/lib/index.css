...
@font-face {
  font-family: 'anticon';
  src: url('http://at.alicdn.com/t/font_1461567603_8950496.eot');
  /* IE9*/
  src: url('http://at.alicdn.com/t/font_1461567603_8950496.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */ url('http://at.alicdn.com/t/font_1461567603_8950496.woff') format('woff'), /* chrome、firefox */ url('http://at.alicdn.com/t/font_1461567603_8950496.ttf') format('truetype'), /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/ url('http://at.alicdn.com/t/font_1461567603_8950496.svg#iconfont') format('svg');
  /* iOS 4.1- */
}
.anticon {
  display: inline-block;
...
.ant-tabs-vertical > .ant-tabs-bar .ant-tabs-ink-bar-transition-forward {
...
.ant-tabs-vertical > .ant-tabs-bar .ant-tabs-ink-bar-transition-backward {
...
.ant-table.ant-table-bordered tfoot tr {
  top: 0;
}
...
.ant-tag-zoom-enter,
.ant-tag-zoom-appear {
  -webkit-animation: antZoomIn 0.2s cubic-bezier(0.78, 0.14, 0.15, 0.86);
...
.ant-select-tree-checkbox-group-item:first-child {
  margin-left: 0;
}
.ant-select-tree {
  margin: 0;
